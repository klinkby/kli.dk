...
> engineers.
> This is the second in a series of blog posts with practical advise on how to reduce your container's attack surface by
> revoking service `root` privileges.
...
> Update 2023-03-22: Microsoft is ~~finally~~ also making this default for .NET 8, see
> the [announcement](https://devblogs.microsoft.com/dotnet/securing-containers-with-rootless/). Great news!
